...
// const useCountDown = dynamic(() => import('@/hooks/useCountDown'), { ssr: false })
        ...
        <>
            {
                isClient ?
                    ...
                    <div className={`countdown-section position-relative ${prantClass}`} suppressHydrationWarning>
                        <div className={isBg}>
                            <div className="container">
                                ...
                                <div className={`countdown ${countdownGradient}`}>
                                    <div className="row row-cols-2 row-cols-lg-3 row-cols-xl-4 justify-content-between align-items-center">
                                        <Col name={"Days"} time={days} labelClass={labelClass} timeClass={timeClass} id="days" />
                                        <Col name={"Hours"} time={hours} labelClass={labelClass} timeClass={timeClass} id="hours" />
                                        <Col name={"Minutes"} time={minutes} labelClass={labelClass} timeClass={timeClass} id="minutes" />
                                        <Col name={"Seconds"} time={seconds} labelClass={labelClass} timeClass={timeClass} id="seconds" />
