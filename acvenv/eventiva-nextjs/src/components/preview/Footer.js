            ...
            <div className="container">
                <div className="row gy-lg-0 gy-10 justify-content-between align-items-center text-center text-lg-start">
                    <div className="col-lg-4 order-3 order-lg-1">
                        <p className="custom-roboto custom-font-style-1">&copy; 2024 <Link href="https://themeperch.net/" className="text-primary text-decoration-none" target="_blank">Themeperch</Link>. All rights Reserved.</p>
                    </div>
