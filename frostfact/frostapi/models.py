...
#         # Check if a ClientProfile already exists for this customer_email
#         existing_profile = ClientProfile.objects.filter(client_email=self.customer_email).exists()
#
#         if not existing_profile:
#             # Create a new ClientProfile instance only if it doesn't already exist
...
#             self.save()  # Save the ContactFormSubmission instance after creating ClientProfile
#         else:
#             # If ClientProfile already exists, just save the ContactFormSubmission instance
#             super(ContactFormSubmission, self).save()
#
#
